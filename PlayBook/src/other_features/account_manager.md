...
<img width="200" src="../images/delete_account_menu.png">

In the selection menu, you can choose an account you have previously stored to delete.

<img width="800" src="../images/delete_account_prompt.png">
