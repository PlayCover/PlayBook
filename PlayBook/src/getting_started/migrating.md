...
### Updating your apps
If you installed an app on an older build of PlayCover (before 2.0.0) and try to update the same app to a newer version on a newer build of PlayCover (2.0.0 and later), you will encounter an issue where the newer version of the app fails to replace the older version and two of the same app icons will be present at the same time. When this happens, you follow these steps to uninstall the older version without losing your logins and data.
